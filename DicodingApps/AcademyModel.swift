...
let dummyAcademyData = [
    ...
    AcademyModel(
        ...
        description: "Pelajar cara membuat aplikasi pertamamu dengan Xcode. Kelas ini mengajarkan dasar yang dibutuhkan mulai dari Controller sampai TableViews."
    ),
    AcademyModel(
        id: 209,
    ...
    AcademyModel(
        ...
        description: "Pelajar kelima prinsip desain yang merupakan pedoman untuk rancangan kode yang baik pada pemrograman berorientasi objek (OOP)."
    ),
    AcademyModel(
        id: 292,
        name: "Meniti Karier sebagai Software Developer",
        image: UIImage(named: "MenitiKarier")!,
        description: "Pelajar berbagai jalur yang tersedia sebagai Software Developer dari sudut pandang developer ahli yang sudah meniti karier di bidangnya."
    ),
    AcademyModel(
        id: 317,
    ...
    AcademyModel(
        ...
        image: UIImage(named: "PengembanganSoftware")!,
        description: "Pelajar langkah menjadi pengembang software dari tahapan analisis dan perencanaan sampai modifikasi perangkat lunak beserta dokumentasi."
    )
]
